 ...
 */
abstract class MyAbsActivity : AppCompatActivity() {
...
//    }
    ...
    protected fun isNotificationEnabled(): Boolean {
        ...
        try {
            ...
            return method.invoke(
                ...
                uid,
                pkg
            ).toString().toInt() == AppOpsManager.MODE_ALLOWED
        } catch (e: Exception) {
            Log.e(e.message!!, "TTT")
        }
        return false
     ...
     */
    private var activityResultListener: ((requestCode: Int, resultCode: Int, data: Intent?) -> Unit)? =
        null
